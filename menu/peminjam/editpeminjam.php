      ...
      <div id="content">
        ...
        <div class="container-fluid px-5 text-gray-800" style="min-height: 100vh">
          ...
          <div class="d-sm-flex align-items-center mb-4">
            <h1 class="h3 mb-4">Edit Anggota Peminjam</h1>
          </div>
          ...
          <form action="proseseditpeminjam.php?id_peminjam=<?php echo $lihat['id_anggota'];?>" method="post" enctype="multipart/form-data">
            <div class="mb-4">
              <label for="username" class="form-label">Username</label>
              <input type="text" class="form-control" id="username" name="username" value="<?php echo $lihat['nama'] ?>" required autofocus>
            </div>
            <div class="mb-4">
                <label for="divisi" class="form-label">Divisi</label>
                <br>                                 
                <select name="divisi" class="form-select" aria-label="Default select example" required>
                    <option value="<?php echo $lihat['divisi']?>" selected><?php echo $lihat['divisi'] ?></option>
            ...
            <div class="mb-4">
              ...
              <input type="tel" class="form-control" id="phone" name="phone" value="<?php echo $lihat['kontak'] ?>" required>
