          ...
          <div class="row">
            <div class="col-md-12">
              <div class="mb-3 d-flex justify-content-end">
                <a href="tambahakun.php" class="btn btn-success"><i class="fa fa-plus"></i> Tambah</a>
              </div>
            </div>
          </div>
                  ...
                  <tbody>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <form action="hapusakun.php?id_akun=<?php echo $lihat['id']; ?>" onsubmit="return confirm('Yakin ingin hapus <?php echo $lihat['username']; ?>?');" method="POST">
                            <a href="editakun.php?id_akun=<?php echo $lihat['id']; ?>" class="btn btn-warning">Edit</a>
