      ...
      <div id="content">
        ...
        <div class="container-fluid px-5 text-gray-800" style="min-height: 100vh">
          ...
          <div class="d-sm-flex align-items-center mb-4">
            <h1 class="h3 mb-4">Edit Akun</h1>
          </div>

          <?php
          $id_akun = $_GET['id_akun'];
          $query = $mysqli->query("SELECT * FROM users where id='$id_akun'");
          $lihat = mysqli_fetch_array($query)
          ?>
            <form action="proseseditakun.php?id_akun=<?php echo $lihat["id"]?>" method="post" enctype="multipart/form-data">
                <div class="mb-4">
                    <label for="username" class="form-label">Username</label>
                    <input type="text" class="form-control" id="username" name="username" value="<?php echo $lihat['username'];?>" required autofocus>                
                </div>
                <div class="mb-4">
                ...
                <div class="mb-4">                                                        
                    ...
                    <select name="role" id="role" class="form-select" aria-label="Default select example" required>
                        ...
                        <option value="admin" <?php if($lihat['role'] == 'admin') echo 'selected="selected"'; ?>>Admin</option>
                        <option value="anggota" <?php if($lihat['role'] == 'anggota') echo 'selected="selected"'; ?>>Anggota</option>                                                          
                    </select>
                </div>
                <div class="d-flex">
