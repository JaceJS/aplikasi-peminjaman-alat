...
$pdf->Cell(50, 10, 'Tanggal Booking', 1, 0, 'C', 1);
...
$pdf->Cell(45, 10, 'Status Pengembalian', 1, 1, 'C', 1);
...
while ($lihat = mysqli_fetch_array($query)) {
    $pdf->Cell(15, 10, $no++, 1);
    $pdf->Cell(50, 10, date('d-M-Y  h:i A', strtotime($lihat['tgl_booking'])), 1);
    ...
    $pdf->Cell(45, 10, $lihat['status'] == 1 ? 'Sudah Dikembalikan' : 'Belum Dikembalikan', 1, 0, 'C', true);
    $pdf->SetFillColor(255, 255, 255);
    $pdf->Ln();
}
