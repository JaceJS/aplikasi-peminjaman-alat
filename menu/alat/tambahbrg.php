      ...
      <div id="content">
        ...
        <div class="container-fluid px-5 text-dark" style="min-height: 100vh">
          ...
          <div class="d-sm-flex align-items-center mb-4">
            <h1 class="h3 mb-4">Tambah Alat</h1>
          </div>

          <form action="prosestambahbrg.php" method="post" enctype="multipart/form-data">
            <div class="mb-4">
              <label for="namaBarang" class="form-label">Nama Alat</label>
              <input type="text" class="form-control" id="namaBarang" name="nama_brg" placeholder="Masukkan nama alat" required autofocus>
            </div>
            <!-- Inputan Jenis Alat-->
            <div class="mb-4">
            ...
            <!-- <div class="mb-4">
              ...
              <input type="number" class="form-control" id="stokBarang" name="stok_brg" placeholder="Masukkan stok alat" required>
            </div> -->
            <div class="mb-4">
              <label for="kode" class="form-label">Kode Alat</label>
              <input type="text" class="form-control" id="kode" name="kode" placeholder="Masukkan kode alat" required>
            </div>
            <div class="mb-4">
